<div class="media-upload-block" data-name="<?php echo  $field->args( '_id' ) ; ?>">
     <div class="property-media">
                            ...
                            foreach( $property_images as $image_id => $url ) {
                                ...
                                echo '<div class="col-sm-2">';
                                    echo '<div class="gallery-thumbnail">';
                                        ...
                                        echo '</a>';
                                        echo '<a class="icon icon-fav icon-featured" data-toggle="tooltip" title="'.__('Set featured image', 'opaljob').'" data-property-id="'.intval($post_id).'" data-attachment-id="'.intval($image_id).'" href="javascript:;">';
            ...
            <div id="drag-and-drop" class="media-drag-drop">
                <h4><i class="fa fa-cloud-upload"></i><?php esc_html_e( 'Drag and drop images here', 'opaljob' ); ?></h4>
                <h4><?php esc_html_e( 'or', 'opaljob' ); ?></h4>
                <a id="select-images" href="javascript:;" class="btn btn-primary btn-3d"><?php esc_html_e( 'Select Images', 'opaljob' ); ?></a>
            </div>
