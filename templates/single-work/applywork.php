...
$post_id = (int)Opaljob_Query::get_company_by_work($post->ID);
...
<div class="opaljob-box work-apply-section">
	<div class="row">
		<div class="col-lg-12 work-apply-contact">
			                        ...
			                        <div class="box-content company-contact-form">              
			                            <form method="post" action="" class="opaljob-contact-form">
			                                ...
			                                <div class="form-group">
			                                    <input class="form-control" name="name" value="<?php echo $current_user->display_name; ?>" type="text" placeholder="<?php echo __( 'Name', 'opaljob' ); ?>" required="required">
			                                </div><!-- /.form-group -->
			                                ...
			                                <div class="form-group">
			                                    ...
			                                    <label>
			                                        <a class="create-resume" href="<?php echo opaljob_submssion_resume_page(); ?>" >
