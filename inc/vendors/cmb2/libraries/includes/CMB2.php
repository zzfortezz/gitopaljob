...
class CMB2 {
	...
	public function render_group( $args ) {
		...
		if ( $field_group->args( 'repeatable' ) ) {
			echo '<div class="cmb-row"><div class="cmb-td"><p class="cmb-add-row"><button data-selector="', $field_group->id(), '_repeat" data-grouptitle="', $field_group->options( 'group_title' ), '" class="cmb-add-group-row btn btn-default btn-3d">', $field_group->options( 'add_button' ), '</button></p></div></div>';
		}
				...
				if ( $field_group->args( 'repeatable' ) ) {
					...
					<div class="cmb-row cmb-remove-field-row">
						<div class="cmb-remove-row">
							<button ', $remove_disabled, 'data-selector="', $field_group->id(), '_repeat" class="btn btn-default btn-3d cmb-remove-group-row alignright">', $field_group->options( 'remove_button' ), '</button>
						</div>
					</div>
					';
				}
