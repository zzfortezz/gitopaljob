<div class="opaljob-search-resumes">
	<div class="inner">
		<div class="container">
			<div class="search-resumes-form">
				<?php Opaljob_Search::renderResumeHorizontalForm(); ?> 
			</div>
		</div>	
	</div>
</div>	
				...
				<div id="content" class="site-content" role="main">
					...
					<?php
						if( class_exists("OpalJob_Search") ): 
							...
							$query = OpalJob_Search::getSearchResumeResultsQuery();
						?>
											...
											<?php if ( (isset($_COOKIE['opaljob_displaymode']) && $_COOKIE['opaljob_displaymode'] == 'list') || (!isset($_COOKIE['opaljob_displaymode']) && opaljob_options('displaymode', 'grid') == 'list') ):?>
												<?php while ( $query->have_posts() ) : $query->the_post(); ?>
													<div class="col-lg-12 col-md-12 col-sm-12">
								                    	<?php echo Opaljob_Template_Loader::get_template_part( 'content-resume-list' ); ?>
								                	</div>
								                <?php endwhile; ?>
											<?php else : ?>
												...
												?>
													<div class="<?php echo $cls; ?>col-lg-4 col-md-4 col-sm-6">
								                    	<?php echo Opaljob_Template_Loader::get_template_part( 'content-resume-grid' ); ?>
								                	</div>
												<?php endwhile; ?>
											<?php endif; ?>
										</div>
